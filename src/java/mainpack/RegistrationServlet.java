...
OracleResultSet ors = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          if(ors.next())
          {
                response.sendRedirect("http://localhost:8084/Travel_Booking_System/STATIC-PAGES/ExistingEmail.html");
          }else{
              oconn = (OracleConnection)DriverManager.getConnection("jdbc:oracle:thin:@Avik7:1522:orcl","TIITSM","DATABASE");
...
//                 int x=ops.executeUpdate();
                 response.sendRedirect("http://localhost:8084/Travel_Booking_System/STATIC-PAGES/RegistrationSuccess.html");
          }   
                ops.close();
                oconn.close();
