    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(ors.next()) 
            {
                ...
                final String username ="uchihaiitachi74@gmail.com";
                final String password = "badzidjnvrfzpxqy";
            ...
            try {
                    ...
                    response.sendRedirect("http://localhost:8084/Travel_Booking_System/SERVER-PAGES/ForgotLogin.jsp");
