...
catch(Exception ex)
{
                ...
                <script>
                    ...
                    location.href="http://localhost:8084/Travel_Booking_System/STATIC-PAGES/ValidateEmail.html";
                </script>
                <%  
}
%>
...
//                    vemail = sess.getAttribute("email").toString();
 ...
 <div class="forpass-form-container">
    ...
    <form method="post" action="http://localhost:8084/Travel_Booking_System/SERVER-PAGES/ForgotLogin.jsp"onsubmit="return validateForm()">
