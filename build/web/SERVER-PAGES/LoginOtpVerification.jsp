...
<%
            if(request.getParameter("Verify")!=null)
            {
                ...
                <script>
                    ...
                    location.href="http://localhost:8084/Travel_Booking_System/STATIC-PAGES/loginSuccess.html";
                </script>
                <%
                }
                else
...
%>
    ...
    <div class="Verification-form-container">
      ...
      <form method="post" action="http://localhost:8084/Travel_Booking_System/SERVER-PAGES/LoginOtpVerification.jsp">
          <h3>Verification</h3>
          ...
          <p>Back to login? <a href="http://localhost:8084/Travel_Booking_System/STATIC-PAGES/login.html" >click here</a></p>
      </form>
    </div>
    </body>
</html>
