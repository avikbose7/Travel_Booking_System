...
<header>
   ...
   <div class="icons">
      ...
      <a href="STATIC-PAGES/login.html" id="login-link">
            ...
            <div id="signOut" style="display: none; "><a href="http://localhost:8084/Travel_Booking_System/sessionLogOut"><i class="fas fa-sign-out" id=""></i></a></div>
   </div>
...
<div class="container contact">
   ...
   <section>
      ...
      <div class="row">
         ...
         <form action="http://localhost:8084/Travel_Booking_System/contactUs" method="post" data-aos="flip-right">
